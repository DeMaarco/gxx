...
- Solo los archivos que las herramientas abren realmente van al proveedor activo. El catálogo de Agent Skills (name + description) se envía cada turno; los cuerpos y paths cargados con `read_skill` también van al proveedor.

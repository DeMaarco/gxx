...
Los tamaños de contexto siguen la ventana oficial de cada modelo: OpenAI `272k` o `1m`, Claude `300k` (presupuesto más barato) o `1m` (Haiku `200k`). Al cambiar de modelo se ajusta un tamaño no soportado.
